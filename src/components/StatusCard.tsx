...
const StatusCard: React.FC<StatusCardProps> = ({ cap, title, statusColor }) => {
  return (
    <div className="relative w-full min-h-20 rounded-xl bg-linear-to-br from-primary/60 to-primary/30 backdrop-blur-md py-4 px-4 flex flex-col justify-between shadow-lg">
      {/* Punto de estado */}
      <div
